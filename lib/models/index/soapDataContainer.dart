  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: themeData.soapThemeColors[data.type.index][0],
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  "레시피테스트이름",
                  style: TextStyle(
                    color: themeData.soapThemeColors[data.type.index][1],
                    fontSize: 18,
                ...
                Text(
                  "C.P",
                  style: TextStyle(
                    color: themeData.soapThemeColors[data.type.index][2],
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                  ),
                ),
          ...
          Positioned(
            ...
            child: SvgPicture.asset(
              ...
              width: 120,
              height: 120,
              color: themeData.soapThemeColors[data.type.index][2].withOpacity(0.2),
            ),
          ),
          Positioned(
            right: 4,
